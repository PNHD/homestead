...
import { PRODUCT_BY_NAME, computeMaterialFlows, computeServe, computeSkillUsage, computeSummary, effectiveFarmFields, liveInventory, outputPerHr, reSync, surplusTradeByProduct, tradePrice } from "../src/utils/calc.ts";
...
assert(tradePrice(PRODUCT_BY_NAME["Bronze-Clad Pine Jug"]) === 6, "Bronze-Clad Pine Jug trade price should match game screenshot");
assert(tradePrice(PRODUCT_BY_NAME["Amber-Glazed Brass Jug"]) === 6, "Amber-Glazed Brass Jug trade price should match game screenshot");
